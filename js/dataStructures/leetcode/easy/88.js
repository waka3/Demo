 ...
 */
 var merge = function (nums1, m, nums2, n) {
  const midNum1 = nums1.slice(0, m)
  let i = 0, j = 0;
  while (i < m || j < n) {
    if (midNum1[i] === undefined || midNum1[i] >= nums2[j]) {
   ...
   return nums1 // Do not return anything, modify nums1 in-place instead. 在leetcode上提交代码可以省略此行，运行速度也会上升
};
